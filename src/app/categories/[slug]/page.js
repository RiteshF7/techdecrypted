...
const blogs = allBlogs.filter(blog => {
  ...
  return (
    <article className="mt-12 flex flex-col text-dark dark:text-light">
      ...
      <div className="grid  grid-cols-1 sm:grid-cols-2  lg:grid-cols-3 grid-rows-2 gap-8 mt-5 sm:mt-10 md:mt-24 mb-24 sxl:mt-32 px-5 sm:px-10 md:px-24 sxl:px-32">
