  ...
  return (
    <header className="w-full p-4  px-5 sm:px-10 flex items-center justify-between">
        ...
        <div className=" hidden sm:flex items-center">
            ...
            {/* <a href={siteMetadata.phone} rel="noopener noreferrer" className="inline-block w-6 h-6 mr-4" aria-label="Reach out to me via Phone Number" target="_blank"><PhoneIcon className="hover:scale-125 transition-all ease duration-200" /></a> */}
            ...
            <a href={siteMetadata.portfolio} rel="noopener noreferrer" className="inline-block w-6 h-6 mr-4" aria-label="Check my portfolio" target="_blank"><PortfolioIcon className="hover:scale-125 transition-all ease duration-200" /></a>
        </div>
    </header>
  )
}
